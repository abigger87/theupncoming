        ...
        <div className="col-12 col-md-10 col-lg-6 offset-md-1 offset-lg-0 row-content">
            <div className="h-100 d-flex flex-column py-5 px-4 px-sm-5 justify-content-center">
              ...
              <h4 className="font-size-subheader mb-4">
                This is Up N Coming's website built using Chec’s headless architecture and the Commerce.js SDK. 
                {/*Commerce.js is a smarter, more efficient way to build eCommerce projects, and we hope you can see that as you explore the world custom eCommerce. 
                Please build on top of, or pick apart this project for your own use. 
                Everything in this project, from the storefront, to the cart, checkout and receipt, is 100% customizable. 
                To build more custom eCommerce projects, using any frontend framework or platform, head over to <a href="https://commercejs.com/" target="_blank" className="cjs-link" rel="noopener noreferrer">commercejs.com</a>.
                */}
              </h4>
      ...
      <div className="row">
        ...
        <div className="col-12 col-md-10 col-lg-6 offset-md-1 offset-lg-0 row-content">
          <div className="h-100 d-flex flex-column justify-content-center py-5 px-4 px-sm-5">
            ...
            <div className="mt-3">
              <a className="px-4 py-3 flex-grow-1 font-color-white about-net" href="https://app.netlify.com/start/deploy?repository=https://github.com/abigger87/theupncoming" target="_blank">
                Deploy to Netlify
              </a>
            </div>
          </div>
      ...
      <div className="row">
        <div className="col-12 col-md-10 col-lg-6 offset-md-1 offset-lg-0 row-content">
          <div className="h-100 d-flex flex-column justify-content-center py-5 px-4 px-sm-5">
            ...
            <div className="mt-3">
              <a className="px-4 py-3 flex-grow-1 font-color-white about-gb" href="https://github.com/abigger87/theupncoming" target="_blank">
                Clone in GitHub
              </a>
            </div>
          </div>
